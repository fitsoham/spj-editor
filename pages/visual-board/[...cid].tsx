      ...
      const collageDataWithProductData = {
        ...
        data: data?.meta?.view.map((object) => {
          ...
          return {
            ...
            price: !isError ? productData[object?.product]?.price : 0,
            displayPrice: !isError ? productData[object?.product]?.price : 0,
            retailer: !isError ? productData[object?.product]?.retailer?.name : '',
            renderImages: !isError ? productData[object?.product]?.renderImages : [{ cdn: '' }],
            name: !isError ? productData[object?.product]?.name : '',
            depth: !isError ? productData[object?.product]?.dimension?.depth : 0,
