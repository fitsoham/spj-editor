...
const organizationSchema = {
  ...
  const additionalLinkTags = [
    ...
    { key:"apple-touch-icon-114", rel:"apple-touch-icon" ,sizes:"114x114" ,href:"/logo-icons/apple-icon-114x114.png" },
    { key:"apple-touch-icon-120", rel:"apple-touch-icon" ,sizes:"120x120" ,href:"/logo-icons/apple-icon-120x120.png" },
    { key:"apple-touch-icon-144", rel:"apple-touch-icon" ,sizes:"144x144" ,href:"/logo-icons/apple-icon-144x144.png" },
    { key:"apple-touch-icon-152", rel:"apple-touch-icon" ,sizes:"152x152" ,href:"/logo-icons/apple-icon-152x152.png" },
    { key:"apple-touch-icon-180", rel:"apple-touch-icon" ,sizes:"180x180" ,href:"/logo-icons/apple-icon-180x180.png" },
  ...
  const defaultSEO = {openGraph, twitter, title: 'Spacejoy', additionalMetaTags, additionalLinkTags, facebook, additionRobotsProps};
