...
const BgSelector = () => {
  ...
  return (
    <div className="w-full bg-white shadow-lg py-4 rounded-lg">
        ...
        {imgList.map((img) => {
          return (
            <div
              ...
              onMouseEnter={() => updateBgImage(img?.url)}
              onMouseLeave={resetbgImage}
              key={img.id}
              className="border-transparent box-border flex-shrink-0 h-36 w-64 mx-4 relative cursor-pointer"
            >
