...
const Slide = ({ testimonial }) => (
  <div className="pt-24 pb-16 border-r text-center border-white px-16">
    ...
    <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
      <h3 className="text-lg text-red-800">{testimonial.shortDescription}</h3>
      <div className="relative md:flex-grow">
        ...
        <p className="text-sm mt-10">{testimonial.description}</p>
      </div>
      <footer className="mt-8">
        <div className="flex items-center justify-center">
          ...
          <div className="ml-4 text-left">
            ...
            <div className="text-sm font-medium text-red-800">CEO, Tuple</div>
          </div>
        </div>
      </footer>
    </blockquote>
