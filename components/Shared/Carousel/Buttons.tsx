...
const CarouselNavButton: React.FC<CarouselNavButton> = ({ onClick, flow }) => {
  return (
    <button
      className={`relative z-10 h-28 w-28 bg-white shadow-md border border-bg-50 transition hover:shadow-xl rounded-2xl flex items-center justify-center focus:outline-none hover:text-yellow-500 ${
