      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          <div className="px-5 py-2">
            <a className="text-gray-700 hover:text-red-500 block pb-2 text-sm">About</a>
          </div>
          <div className="px-5 py-2">
            <Link href="/online-interior-designers">
              <a className="text-gray-700 hover:text-red-500 block pb-2 text-sm">Team</a>
            </Link>
          </div>
          <div className="px-5 py-2">
            <a className="text-gray-700 hover:text-red-500 block pb-2 text-sm">Blog</a>
          </div>
          <div className="px-5 py-2">
            <Link href="/cookies">
              <a className="text-gray-700 hover:text-red-500 block pb-2 text-sm">Cookies</a>
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/terms">
              <a className="text-gray-700 hover:text-red-500 block pb-2 text-sm">Terms</a>
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/sitemap">
              <a className="text-gray-700 hover:text-red-500 block pb-2 text-sm">Sitemap</a>
            </Link>
          </div>
        </nav>
